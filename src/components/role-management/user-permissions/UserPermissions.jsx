...
import RemoveUserPermissionModal from "./Modals/RemoveUserPermissionModal";



const UserPermissions = ({ newData:data, loading }) => {
  ...
  return (
    <>
      <div className="w-full overflow-auto no-scrollbar  h-auto">
        ...
        >
          <EditUserPermissionModal closeModal={closeModalEdit} />
        </ModalComponent>
        <ModalComponent
        ...
        >
          <RemoveUserPermissionModal closeModal={closeModalDel} />
        </ModalComponent>
        {data?.length === 0 && (
          <div className="flex  justify-center  w-full pt-5">
