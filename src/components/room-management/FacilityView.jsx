    ...
    <div className=" w-full  overflow-auto no-scrollbar  h-auto ">
      <div className=" w-full  flex flex-col  py-5 h-auto">
            ...
            {allRooms?.map((table_data) => (
              ...
              >
                <td className="px-5 py-2 text-left   text-sm">
                  <p>{table_data.location_id.facility_name}</p>
                </td>
                <td className="px-5 py-3 text-sm">{table_data.roomName}</td>
                ...
                <td className="px-5 py-2 text-sm flex items-center">
                  ...
                  <Link
                        href={`/dashboard/room-management/${table_data?._id}`}
                        onClick={() => {
        ...
        {!loading && allRooms.length === 0 && (
          <div className="text-center py-4 text-red-500">No Rooms available for this Facility </div>
        )}
      </div>
    </div>
  );
