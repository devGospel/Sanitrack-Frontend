...
const AddEvidenceLevel = ({ closeModal }) => {
  const params = useSearchParams();
  const { addEvidenceLevel, buttonLoader } = useSettings();
                ...
                >
                  <div className="flex flex-col gap-x-2 w-full h-auto lg:pt-5 pt-5 space-y-4 ">
                    <div className="flex flex-col lg:flex-row gap-4 items-center">
                      <div className="text-black w-full flex flex-col items-start">
                        ...
                        <label className="text-xs font-bold dark:text-white text-black">Name</label>
                          <input
                            id="name"
                            type="text"
                    ...
                    <div className="flex flex-col lg:flex-row gap-4 items-center">
                      <div className="text-black w-full flex flex-col items-start">
                        <div className="relative w-full">
                            <label className="text-xs font-bold dark:text-white text-black">Min Value</label>
                          <input
                            id="minValue"
                            type="number"
                          ...
                          />
                          {errors && errors?.minValue?.type === "required" && (
                            <span className="text-xs text-red-500 ease-out duration-1500 transition-all">
                    ...
                    <div className="flex flex-col lg:flex-row gap-4 items-center">
                      <div className="text-black w-full flex flex-col items-start">
                        <div className="relative w-full">
                          ...
                          />
                          {errors && errors?.maxValue?.type === "required" && (
                            <span className="text-xs text-red-500 ease-out duration-1500 transition-all">
                  ...
                  <div className=" py-3 sm:flex sm:flex-row-reverse">
                    <span className="flex w-full rounded-md shadow-sm  sm:w-full">
                      ...
                      >
                        {buttonLoader ? "Loading..." : "  Add Evidence Level"}
                      </button>
                    </span>
...
export default AddEvidenceLevel;
