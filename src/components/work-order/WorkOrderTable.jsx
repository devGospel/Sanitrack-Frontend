...
const data = [
  ...
  },
  {
    ...
    name: 'Work Order 10',
    rommName: 'Room 10',
    executionDate: '2021-09-10',
    status: 'pending'
  }
]

const WorkOrderTable = ({ _data, loading }) => {
                ...
                <tr key={item?._id} className="border-b border-gray-200">
                  ...
                  <td className="px-5 py-3    text-sm flex items-center">
                    <>
                      ...
                      <Link className=' underline text-black ml-3' href={"/dashboard/work-order/view-order"}>View</Link>
                    </>
                  </td>
                </tr>
              ))}
