...
const ScheduleTable = ({ _data, loading, newData }) => {
    // if (loading) return <div>Loading...</div>

    console.log("firstnnnnnnnnn", newData)
  return (
    <div>
        <Table data={newData} loading={loading} />
    </div>
  )
}
