...
const DataTable = ({ title, data, openModalEdit, openModalDel, dispatch }) => (
    <div className='overflow-x-auto w-full  flex flex-col no-scrollbar py-2 px-4 h-auto'>
...
export default function TaskTable({data, loading}) {
    ...
    const taskData = [
        { id: 1, name: "Mopping Stick", creator:"Admin", date:"22 - 05 - 2024" },
        { id: 2, name: "Mopping Stick", creator:"Admin", date:"22 - 05 - 2024" },
        { id: 3, name: "Mopping Stick", creator:"Admin", date:"22 - 05 - 2024" },
        { id: 4, name: "Mopping Stick", creator:"Admin", date:"22 - 05 - 2024" },
        { id: 5, name: "Mopping Stick", creator:"Admin", date:"22 - 05 - 2024" },
        { id: 6, name: "Mopping Stick", creator:"Admin", date:"22 - 05 - 2024" },
        { id: 7, name: "Mopping Stick", creator:"Admin", date:"22 - 05 - 2024" },
        { id: 8, name: "Mopping Stick", creator:"Admin", date:"22 - 05 - 2024" },
        { id: 9, name: "Mopping Stick", creator:"Admin", date:"22 - 05 - 2024" },
        { id: 10, name: "Mopping Stick", creator:"Admin", date:"22 - 05 - 2024" },
        { id: 11, name: "Mopping Stick", creator:"Admin", date:"22 - 05 - 2024" },
    ...
    return (
        <div className='w-full bg-white h-screen mx-auto'>
            <div className=' w-full flex flex-col no-scrollbar px-4 sm:px-6 py-10'>
                <TaskListHeader heading={"Task List"} paragraph={"Manage, create and oversee task list management within the system."} title="Create New List" path={"/dashboard/task-list/create-task"} />
            ...
            {isModalOpenDel && (
                ...
                >
                    <div className='p-4 flex flex-col'>
                        ...
                        <h1 className='text-sm py-2'>Are You sure u want to delete this Task {currentUserId} ? This action cannot be undone</h1>
