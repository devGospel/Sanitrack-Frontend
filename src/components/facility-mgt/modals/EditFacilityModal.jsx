...
const EditFacilityModal = ({ closeModal }) => {
              ...
              <div>
                ...
                >
                  <div className="flex flex-col gap-x-2 w-full h-auto lg:pt-5 pt-5 space-y-4 ">
                    ...
                    <div className="text-black w-full flex flex-col items-start">
                      <Controller
                        name="country" // Name of the field in the form data
                        control={control}
                        rules={{
                        ...
                        render={({ field }) => (
                          <select
                            ...
                            className="border w-full h-10 md:h-12 px-5  md:text-sm rounded-md outline-none focus:border-slate-400 "
                          >
                            <option hidden>{item?.country}</option>
                          </select>
                        )}
                      />
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <select
                            ...
                            className="border w-full h-10 md:h-12 px-5  md:text-sm rounded-md outline-none focus:border-slate-400 "
                          >
                            <option hidden>{item?.state}</option>
                          </select>
                        )}
                      />
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <select
                            ...
                            className="border w-full h-10 md:h-12 px-5  md:text-sm rounded-md outline-none focus:border-slate-400 "
                          >
                            <option hidden>{item?.city}</option>
                          </select>
                        )}
                      />
                    ...
                    <div className="flex flex-col lg:flex-row gap-4 items-center">
                      <div className="text-black w-full flex flex-col items-start">
                        <div className="relative w-full">
                          ...
                          />
                          {errors && errors?.zip?.type === "required" && (
                            <span className="text-xs text-red-500 ease-out duration-1500 transition-all">
                              {errors?.zip.message}
                            </span>
                          )}
                  ...
                  <div className="bg-gray-50 py-3 sm:flex sm:flex-row-reverse gap-4">
                    ...
                    <span className="flex w-full rounded-md shadow-sm  sm:w-full">
                      <button
                        type="button"
                        // onClick={closeModal}
                        className="inline-flex justify-center w-full rounded-md border-2 border-sanBlue px-4 py-2 bg-white text-base leading-6 font-medium text-sanBlue shadow-sm hover:bg-blue-800 hover:text-white focus:outline-none focus:border-red-700 focus:shadow-outline-red transition ease-in-out duration-150 sm:text-sm sm:leading-5"
                      >
                        Edit Facility
                      </button>
                    </span>
