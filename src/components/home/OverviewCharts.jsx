...
const OverviewCharts = ({ cleaningData }) => {
  ...
  return (
    <>
      <span className="p-2 text-black text-xl  mb-5">
        <h2 className="text-center font-bold text-black dark:text-white">Cleaning Data Overview</h2>
      </span>
      <span className="flex justify-start mb-5">
        <select
          id="currency"
          name={"Currency"}
         defaultValue="bar"
          onChange={handleChartChange}
          className="w-auto py-1 sm:px-3 font-bold bg-white dark:bg-black dark:text-white rounded-lg  text-xs md:text-base text-black border-blue-300 cursor-pointer"
        >
      ...
      {selectedChart === "bar" ? (
        <div className="h-72 lg:h-[500px] mx-auto flex flex-col  w-full p-4 bg-white dark:bg-black text-black dark:text-white shadow-lg ">
