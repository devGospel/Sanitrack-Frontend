import SingleFacilityComp from "@/components/facility-mgt/SingleFacilityComp";
...
const SingleFacility = () => {
  return (
    <div className="text-black  bg-white dark:bg-slate-900  h-screen  lg:px-10 p-5 w-full">
